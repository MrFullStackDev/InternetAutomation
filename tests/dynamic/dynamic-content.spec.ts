...
test.describe('Dynamic Content', () => {
  test('renders at least three text blocks with content @regression', async ({ dynamicContentPage }) => {
  ...
  test('still has at least three blocks after a refresh @regression', async ({ dynamicContentPage }) => {
    await dynamicContentPage.goto();
